    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int fatiuge = 10;
                ...
                switch (numChoice)
                {
                    ...
                    case (int)diff.Medium:
                        Console.WriteLine("Goody not too hard and not too easy a brilliant middle ground." +
                             "Would you like to \n1. Walk\n2. Jog\n3. Run\nWe're on a path most rough so it just about how fast you want to end the journey in this world.\n" +
                             "Ptss you're fatiuge is currently " + fatiuge);
                        int easySpeedChoice4 = Convert.ToInt32(Console.ReadLine());
                        if (easySpeedChoice4 == 1)
                        {
                            fatiuge -= 2;
                            Console.WriteLine("A bumpy walk down a none paved and in disrepair path await us, it may be long but it will be safe enough i guess." +
                                "\nWould you like to speed up or not? The choice remains the same as last time.");
                            int easySpeedChoice5 = Convert.ToInt32(Console.ReadLine());
                            if (easySpeedChoice5 == 1)
                            {
                                fatiuge -= 2;
                                Console.WriteLine("As our walk continues we shouldn't encounter any danger thanks to the somewhat regular patrols by the knight core but nothing is definate.\n" +
                                    "We should make it to the end of our journey by nightfall, ths is our last chance to change speed\nSame as last time 1 to 3");
                    ...
                    case (int)diff.Hard:
                        Console.WriteLine("Oh, you like a challenge, or brambles but eitherway, thats a sight for sore eyes." +
                            "Would you like to \n1. Walk\n2. Jog\n3. Run\nWe're on a path most rough so it just about how fast you want to end the journey in this world.\n" +
                            "Ptss you're fatiuge is currently " + fatiuge);
                        int hardSpeedChoice = Convert.ToInt32(Console.ReadLine());
                        if (hardSpeedChoice == 1)
                        {
                            fatiuge -= 3;
                            Console.WriteLine("A path filled with danger and pain, we must be carful and make wise moves, you definatly made the correct choice to walk." +
                                "\nWould you like to speed up or not? The choice remains the same as last time.");
                            int hardSpeedChoice2 = Convert.ToInt32(Console.ReadLine());
                            if (hardSpeedChoice2 == 1)
                            {
                                fatiuge -= 3;
                                Console.WriteLine("As our teck continues making those wise choices is a must, especially since there are no knights that patrol this route.\n" +
                                    "We should make it to the end of our journey after nightfall at this pace, ths is our last chance to change speed\nSame as last time 1 to 3");
                                int hardSpeedChoice3 = Convert.ToInt32(Console.ReadLine());
                                if (hardSpeedChoice3 == 1)
                                {
                                    fatiuge -= 3;
                                    Console.WriteLine("We've made it to the end of the road, woudld you like to rest? Y/N");
                                    string restChoice2 = Console.ReadLine();
                                    if (restChoice2 == "Y")
                                    {
                                        fatiuge = 10;
                                        Console.WriteLine("Wise choice my friend your fatiuge is now at " + fatiuge + "\nFully ressted i see.");
                                    }
                                    else if (restChoice2 == "N")
                                    {
                                        Console.WriteLine("Your current fatigue points rest at " + fatiuge + " thats okay i guess");
                                    }
                                    else
                ...
                if (fatiuge <= 0)
                {
                    Console.WriteLine("You have become too exhusted and faint, adventure over.");
                }
