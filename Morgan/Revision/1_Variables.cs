...
namespace MCarpenter_Revision1_Variables
{
    class Program
    {
        static void Main(string[] args)
        {
            // A variable acts as a container for a single piece of data.
            // Variables must be declared with a data type, and can then be assigned
            // data of that type.
